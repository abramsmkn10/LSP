    ...
    .rtl table tr td:nth-child(2) {
                                            ...
                                            <input type="number" name="jumlah" class="form-control" placeholder="Masukkan Jumlah" required>
                                                ...
                                                <div><br>   
                                                    <div class="button-icon">
                                                        <button type="submit" class="btn btn-rounded btn-info">Tambah</button>
                                                    </div>
                                                </div><br>
                                                </form>
        <form>
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="item">
                ...
                <td>
                     <a href="{{route('transaksi_hapus', $carts->id)}}"><i class="fa fa-times" aria-hidden="true" title="Hapus"></i></a>
                </td>
