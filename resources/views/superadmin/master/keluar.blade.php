     ...
     <div class="container-fluid">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Data Input Barang Keluar</h3>
          ...
          <!-- /.card-header -->
          <form method="post" action="{{url('superadmin/keluar/save')}}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
              ...
              <!-- /.col -->
                <div class="col-md-6">
                  <div class="form-group">
                    <input required="" class="form-control " type="text" placeholder="Silahkan Masukkan VIA produk" name="type_keluar">
                  </div>
                  <div class="form-group">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">DataTable Barang Keluar</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="{{url('superadmin/keluar/delete/'.$row->id)}}" onclick="return confirm('Are you sure want delete?');"><i class="fa fa-trash"></i></a></td>
                  </tr>
                  ...
                  <div class="modal fade show" id="modalanjing{{$row->id}}">
                    <div class="modal-dialog">
                      <div class="modal-content bg-info">
                        ...
                        <form method="post" action="{{url('superadmin/keluar/update')}}" enctype="multipart/form-data">
				            @csrf
				             ...
				             <input type="text" name="id" value="{{$row->id}}" hidden="">
				                  ...
				                  <div class="form-group">
				                    <input required="" class="form-control " value="{{$row->type_keluar}}" type="text" placeholder="Silahkan Masukkan VIA produk" name="type_keluar">
				                  </div>
				                  <div class="form-group">
