...
@section('beritahu')
  <li class="breadcrumb-item active">Informasi Brand</li>
@endsection
     ...
     <div class="container-fluid">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Data Input Informasi Brand</h3>
          ...
          <!-- /.card-header -->
          <form method="post" action="{{url('superadmin/brand/save')}}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <input required="" class="form-control " type="text" placeholder="Nama Brand" name="nama">
                  </div>
                  ...
                  <div class="form-group">
                    <textarea  required="" class="form-control " rows="3" placeholder="Alamat..." name="alamat" style="height: 102px;"></textarea>
                  </div>
                </div>
              <!-- /.col -->
                <div class="col-md-6">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="{{url('superadmin/brand/delete/'.$row->id)}}" onclick="return confirm('Are you sure want delete?');"><i class="fa fa-trash"></i></a></td>
                  </tr>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content bg-info">
                        ...
                        <div class="modal-body" style="background: white;">
                         <form action="{{url('superadmin/brand/update')}}" method="POST" enctype="multipart/form-data">
                          @csrf
